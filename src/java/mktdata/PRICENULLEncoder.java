...
public class PRICENULLEncoder
{
    ...
    public PRICENULLEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public PRICENULLEncoder mantissa(final long value)
    {
    ...
    {
        PRICENULLDecoder writer = new PRICENULLDecoder();
