...
public class MDInstrumentDefinitionFuture27Decoder
{
    ...
    private final MDInstrumentDefinitionFuture27Decoder parentMessage = this;
    ...
    public MDInstrumentDefinitionFuture27Decoder wrap(
     ...
     *
     * @return PRICENULLDecoder : Reference price for prelisted instruments or the last calculated Settlement whether it be Theoretical, Preliminary or a Final Settle of the session.
     */
        ...
        implements Iterable<NoEventsDecoder>, java.util.Iterator<NoEventsDecoder>
    {
        ...
        private final MDInstrumentDefinitionFuture27Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoEventsDecoder(final MDInstrumentDefinitionFuture27Decoder parentMessage)
        {
        ...
        implements Iterable<NoMDFeedTypesDecoder>, java.util.Iterator<NoMDFeedTypesDecoder>
    {
        ...
        NoMDFeedTypesDecoder(final MDInstrumentDefinitionFuture27Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoInstAttribDecoder>, java.util.Iterator<NoInstAttribDecoder>
    {
        ...
        NoInstAttribDecoder(final MDInstrumentDefinitionFuture27Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoLotTypeRulesDecoder>, java.util.Iterator<NoLotTypeRulesDecoder>
    {
        ...
        NoLotTypeRulesDecoder(final MDInstrumentDefinitionFuture27Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[MDInstrumentDefinitionFuture27](sbeTemplateId=");
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICE', referencedName='null', description='PRICE', id=-1, version=0, deprecated=0, encodedLength=8, offset=91, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='FLOAT', referencedName='null', description='Decimal', id=-1, version=0, deprecated=0, encodedLength=8, offset=99, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='float'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Price NULL', id=-1, version=0, deprecated=0, encodedLength=8, offset=140, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        ...
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=4, offset=157, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=4, offset=161, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Price NULL', id=-1, version=0, deprecated=0, encodedLength=8, offset=165, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Price NULL', id=-1, version=0, deprecated=0, encodedLength=8, offset=173, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Price NULL', id=-1, version=0, deprecated=0, encodedLength=8, offset=181, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Price NULL', id=-1, version=0, deprecated=0, encodedLength=8, offset=205, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("minPriceIncrementAmount=");
        minPriceIncrementAmount().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='UserDefinedInstrument', referencedName='null', description='User-defined instruments flag', id=9779, version=3, deprecated=0, encodedLength=1, offset=213, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='char'}}
