...
public class MDInstrumentDefinitionSpread56Decoder
{
    ...
    private final MDInstrumentDefinitionSpread56Decoder parentMessage = this;
    ...
    public MDInstrumentDefinitionSpread56Decoder wrap(
    ...
    public void getSecuritySubType(final Appendable value)
    {
        for (int i = 0; i < 5 ; ++i)
        {
    ...
    private final PRICENULL9Decoder minPriceIncrement = new PRICENULL9Decoder();

    /**
     * Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible
     *
     * @return PRICENULL9Decoder : Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible
     */
    public PRICENULL9Decoder minPriceIncrement()
    {
    ...
    private final PRICENULL9Decoder priceRatio = new PRICENULL9Decoder();

    /**
     * Used for price calculation in spread and leg pricing
     *
     * @return PRICENULL9Decoder : Used for price calculation in spread and leg pricing
     */
    public PRICENULL9Decoder priceRatio()
    {
    ...
    public void getUnitOfMeasure(final Appendable value)
    {
        for (int i = 0; i < 30 ; ++i)
        {
            final int c = buffer.getByte(this.offset + 120 + i) & 0xFF;
            if (c == 0)
            {
                break;
            }
     ...
     *
     * @return PRICENULL9Decoder : Reference price - the most recently available Settlement whether it be Theoretical, Preliminary or a Final Settle of the session
     */
        ...
        implements Iterable<NoEventsDecoder>, java.util.Iterator<NoEventsDecoder>
    {
        ...
        private final MDInstrumentDefinitionSpread56Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoEventsDecoder(final MDInstrumentDefinitionSpread56Decoder parentMessage)
        {
        ...
        implements Iterable<NoMDFeedTypesDecoder>, java.util.Iterator<NoMDFeedTypesDecoder>
    {
        ...
        NoMDFeedTypesDecoder(final MDInstrumentDefinitionSpread56Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoInstAttribDecoder>, java.util.Iterator<NoInstAttribDecoder>
    {
        ...
        NoInstAttribDecoder(final MDInstrumentDefinitionSpread56Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoLotTypeRulesDecoder>, java.util.Iterator<NoLotTypeRulesDecoder>
    {
        ...
        NoLotTypeRulesDecoder(final MDInstrumentDefinitionSpread56Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoLegsDecoder>, java.util.Iterator<NoLegsDecoder>
    {
        ...
        NoLegsDecoder(final MDInstrumentDefinitionSpread56Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
         ...
         *
         * @return PRICENULL9Decoder : Price for the future leg of a UDS Covered instrument 
         */
        ...
        {
            builder.append('(');
            //Token{signal=BEGIN_FIELD, name='LegSecurityID', referencedName='null', description='Leg Security ID', id=602, version=0, deprecated=0, encodedLength=4, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            //Token{signal=BEGIN_FIELD, name='LegSide', referencedName='null', description='Leg side', id=624, version=0, deprecated=0, encodedLength=1, offset=4, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=BEGIN_ENUM, name='LegSide', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=1, offset=4, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            builder.append("legSide=");
            builder.append(legSide());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='LegRatioQty', referencedName='null', description='Leg ratio of quantity for this individual leg relative to the entire multi-leg instrument', id=623, version=0, deprecated=0, encodedLength=1, offset=5, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
            //Token{signal=ENCODING, name='Int8', referencedName='null', description='int8', id=-1, version=0, deprecated=0, encodedLength=1, offset=5, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
            builder.append("legRatioQty=");
            builder.append(legRatioQty());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='LegPrice', referencedName='null', description='Price for the future leg of a UDS Covered instrument ', id=566, version=0, deprecated=0, encodedLength=8, offset=6, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
            //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=6, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
            builder.append("legPrice=");
            legPrice().appendTo(builder);
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='LegOptionDelta', referencedName='null', description='Delta used to calculate the quantity of futures used to cover the option or option strategy', id=1017, version=0, deprecated=0, encodedLength=4, offset=14, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
            //Token{signal=BEGIN_COMPOSITE, name='DecimalQty', referencedName='null', description='A number representing quantity', id=-1, version=0, deprecated=0, encodedLength=4, offset=14, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[MDInstrumentDefinitionSpread56](sbeTemplateId=");
        ...
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='uInt8NULL', id=-1, version=0, deprecated=0, encodedLength=1, offset=18, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        ...
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='Symbol', referencedName='null', description='Instrument Name or Symbol. Previously used as  Group Code ', id=55, version=0, deprecated=0, encodedLength=20, offset=35, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='String'}}
        ...
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='SecuritySubType', referencedName='null', description='Strategy type', id=762, version=0, deprecated=0, encodedLength=5, offset=79, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='String'}}
        //Token{signal=ENCODING, name='SecuritySubType', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=5, offset=79, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='US-ASCII', epoch='null', timeUnit=null, semanticType='String'}}
        ...
        builder.append(userDefinedInstrument());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MatchAlgorithm', referencedName='null', description='Matching algorithm', id=1142, version=0, deprecated=0, encodedLength=1, offset=85, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='char'}}
        //Token{signal=ENCODING, name='CHAR', referencedName='null', description='char', id=-1, version=0, deprecated=0, encodedLength=1, offset=85, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='US-ASCII', epoch='null', timeUnit=null, semanticType='char'}}
        builder.append("matchAlgorithm=");
        builder.append(matchAlgorithm());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MinTradeVol', referencedName='null', description='The minimum trading volume for a security', id=562, version=0, deprecated=0, encodedLength=4, offset=86, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        //Token{signal=ENCODING, name='uInt32', referencedName='null', description='uInt32', id=-1, version=0, deprecated=0, encodedLength=4, offset=86, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        builder.append("minTradeVol=");
        builder.append(minTradeVol());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MaxTradeVol', referencedName='null', description='The maximum trading volume for a security', id=1140, version=0, deprecated=0, encodedLength=4, offset=90, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        //Token{signal=ENCODING, name='uInt32', referencedName='null', description='uInt32', id=-1, version=0, deprecated=0, encodedLength=4, offset=90, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        builder.append("maxTradeVol=");
        builder.append(maxTradeVol());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MinPriceIncrement', referencedName='null', description='Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible', id=969, version=0, deprecated=0, encodedLength=8, offset=94, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=94, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("minPriceIncrement=");
        minPriceIncrement().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='DisplayFactor', referencedName='null', description='Contains the multiplier to convert the CME Globex display price to the conventional price', id=9787, version=0, deprecated=0, encodedLength=8, offset=102, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='float'}}
        //Token{signal=BEGIN_COMPOSITE, name='Decimal9', referencedName='null', description='Decimal with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=102, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='float'}}
        builder.append("displayFactor=");
        displayFactor().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='PriceDisplayFormat', referencedName='null', description='Number of decimals in fractional display price', id=9800, version=0, deprecated=0, encodedLength=1, offset=110, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='uInt8NULL', id=-1, version=0, deprecated=0, encodedLength=1, offset=110, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        builder.append("priceDisplayFormat=");
        builder.append(priceDisplayFormat());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='PriceRatio', referencedName='null', description='Used for price calculation in spread and leg pricing', id=5770, version=0, deprecated=0, encodedLength=8, offset=111, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=111, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("priceRatio=");
        priceRatio().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='TickRule', referencedName='null', description='Tick Rule ', id=6350, version=0, deprecated=0, encodedLength=1, offset=119, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        //Token{signal=ENCODING, name='Int8NULL', referencedName='null', description='int8 optional', id=-1, version=0, deprecated=0, encodedLength=1, offset=119, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=127, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        builder.append("tickRule=");
        builder.append(tickRule());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='UnitOfMeasure', referencedName='null', description='Unit of measure for the products' original contract size', id=996, version=0, deprecated=0, encodedLength=30, offset=120, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='String'}}
        //Token{signal=ENCODING, name='UnitOfMeasure', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=30, offset=120, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='US-ASCII', epoch='null', timeUnit=null, semanticType='String'}}
        ...
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='TradingReferencePrice', referencedName='null', description='Reference price - the most recently available Settlement whether it be Theoretical, Preliminary or a Final Settle of the session', id=1150, version=0, deprecated=0, encodedLength=8, offset=150, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=150, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("tradingReferencePrice=");
        tradingReferencePrice().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='SettlPriceType', referencedName='null', description='Bitmap field of eight Boolean type indicators representing settlement price type', id=731, version=0, deprecated=0, encodedLength=1, offset=158, componentTokenCount=10, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='MultipleCharValue'}}
        //Token{signal=BEGIN_SET, name='SettlPriceType', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=1, offset=158, componentTokenCount=8, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='MultipleCharValue'}}
        builder.append("settlPriceType=");
        builder.append(settlPriceType());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='OpenInterestQty', referencedName='null', description='The total open interest for the market at the close of the prior trading session', id=5792, version=0, deprecated=0, encodedLength=4, offset=159, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=4, offset=159, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        builder.append("openInterestQty=");
        builder.append(openInterestQty());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='ClearedVolume', referencedName='null', description='The total cleared volume of instrument traded during the prior trading session', id=5791, version=0, deprecated=0, encodedLength=4, offset=163, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=4, offset=163, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        builder.append("clearedVolume=");
        builder.append(clearedVolume());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='HighLimitPrice', referencedName='null', description='Allowable high limit price for the trading day', id=1149, version=0, deprecated=0, encodedLength=8, offset=167, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=167, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("highLimitPrice=");
        highLimitPrice().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='LowLimitPrice', referencedName='null', description='Allowable low limit price for the trading day', id=1148, version=0, deprecated=0, encodedLength=8, offset=175, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=175, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("lowLimitPrice=");
        lowLimitPrice().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MaxPriceVariation', referencedName='null', description='Differential value for price banding', id=1143, version=0, deprecated=0, encodedLength=8, offset=183, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=183, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("maxPriceVariation=");
        maxPriceVariation().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MainFraction', referencedName='null', description='Price Denominator of Main Fraction', id=37702, version=0, deprecated=0, encodedLength=1, offset=191, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='uInt8NULL', id=-1, version=0, deprecated=0, encodedLength=1, offset=191, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        builder.append("mainFraction=");
        builder.append(mainFraction());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='SubFraction', referencedName='null', description='Price Denominator of Sub Fraction', id=37703, version=0, deprecated=0, encodedLength=1, offset=192, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='uInt8NULL', id=-1, version=0, deprecated=0, encodedLength=1, offset=192, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
