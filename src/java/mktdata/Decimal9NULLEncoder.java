...
public class Decimal9NULLEncoder
{
    ...
    public Decimal9NULLEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public Decimal9NULLEncoder mantissa(final long value)
    {
    ...
    {
        Decimal9NULLDecoder writer = new Decimal9NULLDecoder();
