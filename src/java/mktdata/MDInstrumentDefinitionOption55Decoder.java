...
public class MDInstrumentDefinitionOption55Decoder
{
    ...
    private final MDInstrumentDefinitionOption55Decoder parentMessage = this;
    ...
    public MDInstrumentDefinitionOption55Decoder wrap(
    ...
    private final PRICENULL9Decoder strikePrice = new PRICENULL9Decoder();

    /**
     * Strike Price for an option instrument
     *
     * @return PRICENULL9Decoder : Strike Price for an option instrument
     */
    public PRICENULL9Decoder strikePrice()
    {
    ...
    private final PRICENULL9Decoder minCabPrice = new PRICENULL9Decoder();

    /**
     * Defines cabinet price for outright options products
     *
     * @return PRICENULL9Decoder : Defines cabinet price for outright options products
     */
    public PRICENULL9Decoder minCabPrice()
    {
     ...
     *
     * @return PRICENULL9Decoder : Minimum constant tick for the instrument
     */
        ...
        implements Iterable<NoEventsDecoder>, java.util.Iterator<NoEventsDecoder>
    {
        ...
        private final MDInstrumentDefinitionOption55Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoEventsDecoder(final MDInstrumentDefinitionOption55Decoder parentMessage)
        {
        ...
        implements Iterable<NoMDFeedTypesDecoder>, java.util.Iterator<NoMDFeedTypesDecoder>
    {
        ...
        NoMDFeedTypesDecoder(final MDInstrumentDefinitionOption55Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoInstAttribDecoder>, java.util.Iterator<NoInstAttribDecoder>
    {
        ...
        NoInstAttribDecoder(final MDInstrumentDefinitionOption55Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoLotTypeRulesDecoder>, java.util.Iterator<NoLotTypeRulesDecoder>
    {
        ...
        NoLotTypeRulesDecoder(final MDInstrumentDefinitionOption55Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoUnderlyingsDecoder>, java.util.Iterator<NoUnderlyingsDecoder>
    {
        ...
        NoUnderlyingsDecoder(final MDInstrumentDefinitionOption55Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        implements Iterable<NoRelatedInstrumentsDecoder>, java.util.Iterator<NoRelatedInstrumentsDecoder>
    {
        ...
        NoRelatedInstrumentsDecoder(final MDInstrumentDefinitionOption55Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[MDInstrumentDefinitionOption55](sbeTemplateId=");
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=80, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=119, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='Decimal9', referencedName='null', description='Decimal with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=127, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='float'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='Decimal9NULL', referencedName='null', description='Optional Decimal with constant exponent -9 ', id=-1, version=9, deprecated=0, encodedLength=8, offset=169, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=177, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=194, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        builder.append(']');
        builder.append('|');
        //Token{signal=BEGIN_GROUP, name='NoRelatedInstruments', referencedName='null', description='Number of related instruments group', id=1647, version=0, deprecated=0, encodedLength=24, offset=-1, componentTokenCount=15, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
