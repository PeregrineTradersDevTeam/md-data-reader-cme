...
public class MDInstrumentDefinitionFuture54Encoder
{
    ...
    private final MDInstrumentDefinitionFuture54Encoder parentMessage = this;
    ...
    public MDInstrumentDefinitionFuture54Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder wrapAndApplyHeader(
    ...
    public MDInstrumentDefinitionFuture54Encoder totNumReports(final long value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder securityUpdateAction(final SecurityUpdateAction value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder lastUpdateTime(final long value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder mDSecurityTradingStatus(final SecurityTradingStatus value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder applID(final short value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder marketSegmentID(final short value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder underlyingProduct(final short value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder securityExchange(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder putSecurityExchange(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public MDInstrumentDefinitionFuture54Encoder securityExchange(final String src)
    {
        final int length = 4;
    ...
    public MDInstrumentDefinitionFuture54Encoder securityExchange(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder securityGroup(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putSecurityGroup(final byte[] src, final int srcOffset)
    {
        final int length = 6;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder securityGroup(final String src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder securityGroup(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder asset(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putAsset(final byte[] src, final int srcOffset)
    {
        final int length = 6;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder asset(final String src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder asset(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder symbol(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putSymbol(final byte[] src, final int srcOffset)
    {
        final int length = 20;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder symbol(final String src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder symbol(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder securityID(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder securityType(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putSecurityType(final byte[] src, final int srcOffset)
    {
        final int length = 6;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder securityType(final String src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder securityType(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder cFICode(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putCFICode(final byte[] src, final int srcOffset)
    {
        final int length = 6;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder cFICode(final String src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder cFICode(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder currency(final int index, final byte value)
    {
        if (index < 0 || index >= 3)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putCurrency(final byte[] src, final int srcOffset)
    {
        final int length = 3;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder currency(final String src)
    {
        final int length = 3;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder currency(final CharSequence src)
    {
        final int length = 3;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder settlCurrency(final int index, final byte value)
    {
        if (index < 0 || index >= 3)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putSettlCurrency(final byte[] src, final int srcOffset)
    {
        final int length = 3;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder settlCurrency(final String src)
    {
        final int length = 3;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder settlCurrency(final CharSequence src)
    {
        final int length = 3;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionFuture54Encoder matchAlgorithm(final byte value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder minTradeVol(final long value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder maxTradeVol(final long value)
    {
    ...
    private final PRICE9Encoder minPriceIncrement = new PRICE9Encoder();

    /**
     * Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible
     *
     * @return PRICE9Encoder : Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible
     */
    public PRICE9Encoder minPriceIncrement()
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder mainFraction(final short value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder subFraction(final short value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder priceDisplayFormat(final short value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder unitOfMeasure(final int index, final byte value)
    {
        if (index < 0 || index >= 30)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionFuture54Encoder putUnitOfMeasure(final byte[] src, final int srcOffset)
    {
        final int length = 30;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public MDInstrumentDefinitionFuture54Encoder unitOfMeasure(final String src)
    {
        final int length = 30;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
        ...
        buffer.putStringWithoutLengthAscii(this.offset + 110, src);
    ...
    public MDInstrumentDefinitionFuture54Encoder unitOfMeasure(final CharSequence src)
    {
        final int length = 30;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
        ...
        for (int i = 0; i < srcLength; ++i)
        {
            final char charValue = src.charAt(i);
            final byte byteValue = charValue > 127 ? (byte)'?' : (byte)charValue;
            buffer.putByte(this.offset + 110 + i, byteValue);
        }

        for (int i = srcLength; i < length; ++i)
        {
            buffer.putByte(this.offset + 110 + i, (byte)0);
        }
     ...
     *
     * @return PRICENULL9Encoder : Reference price for prelisted instruments or the last calculated Settlement whether it be Theoretical, Preliminary or a Final Settle of the session.
     */
    ...
    public MDInstrumentDefinitionFuture54Encoder openInterestQty(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder clearedVolume(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder decayQuantity(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder decayStartDate(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder originalContractSize(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder contractMultiplier(final int value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder contractMultiplierUnit(final byte value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder flowScheduleType(final byte value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder userDefinedInstrument(final byte value)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder tradingReferenceDate(final int value)
    {
    ...
    public static class NoEventsEncoder
    {
        ...
        private final MDInstrumentDefinitionFuture54Encoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;

        NoEventsEncoder(final MDInstrumentDefinitionFuture54Encoder parentMessage)
        {
    ...
    public static class NoMDFeedTypesEncoder
    {
        ...
        NoMDFeedTypesEncoder(final MDInstrumentDefinitionFuture54Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public static class NoInstAttribEncoder
    {
        ...
        NoInstAttribEncoder(final MDInstrumentDefinitionFuture54Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public static class NoLotTypeRulesEncoder
    {
        ...
        NoLotTypeRulesEncoder(final MDInstrumentDefinitionFuture54Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    {
        MDInstrumentDefinitionFuture54Decoder writer = new MDInstrumentDefinitionFuture54Decoder();
