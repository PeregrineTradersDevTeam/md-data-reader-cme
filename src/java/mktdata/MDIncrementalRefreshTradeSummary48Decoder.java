...
public class MDIncrementalRefreshTradeSummary48Decoder
{
        ...
        implements Iterable<NoMDEntriesDecoder>, java.util.Iterator<NoMDEntriesDecoder>
    {
        ...
        public StringBuilder appendTo(final StringBuilder builder)
        {
            ...
            //Token{signal=BEGIN_COMPOSITE, name='PRICE9', referencedName='null', description='Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=0, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
