...
public class SnapshotFullRefreshOrderBook53Encoder
{
    ...
    private final SnapshotFullRefreshOrderBook53Encoder parentMessage = this;
    ...
    public SnapshotFullRefreshOrderBook53Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public SnapshotFullRefreshOrderBook53Encoder wrapAndApplyHeader(
    ...
    public SnapshotFullRefreshOrderBook53Encoder lastMsgSeqNumProcessed(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53Encoder totNumReports(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53Encoder securityID(final int value)
    {
    ...
    public SnapshotFullRefreshOrderBook53Encoder noChunks(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53Encoder currentChunk(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53Encoder transactTime(final long value)
    {
    ...
    public static class NoMDEntriesEncoder
    {
        ...
        private final SnapshotFullRefreshOrderBook53Encoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;

        NoMDEntriesEncoder(final SnapshotFullRefreshOrderBook53Encoder parentMessage)
        {
         ...
         * Order Price
         *
         * @return PRICE9Encoder : Order Price
         */
    ...
    {
        SnapshotFullRefreshOrderBook53Decoder writer = new SnapshotFullRefreshOrderBook53Decoder();
