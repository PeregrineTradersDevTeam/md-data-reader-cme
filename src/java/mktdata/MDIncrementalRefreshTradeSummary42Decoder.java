...
public class MDIncrementalRefreshTradeSummary42Decoder
{
        ...
        implements Iterable<NoMDEntriesDecoder>, java.util.Iterator<NoMDEntriesDecoder>
    {
        ...
        private final MDIncrementalRefreshTradeSummary42Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoMDEntriesDecoder(final MDIncrementalRefreshTradeSummary42Decoder parentMessage)
        {
         ...
         * Trade price
         *
         * @return PRICEDecoder : Trade price
         */
        ...
        {
            builder.append('(');
            //Token{signal=BEGIN_FIELD, name='MDEntryPx', referencedName='null', description='Trade price', id=270, version=0, deprecated=0, encodedLength=8, offset=0, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
            //Token{signal=BEGIN_COMPOSITE, name='PRICE', referencedName='null', description='PRICE', id=-1, version=0, deprecated=0, encodedLength=8, offset=0, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
            builder.append("mDEntryPx=");
            mDEntryPx().appendTo(builder);
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='MDEntrySize', referencedName='null', description='Consolidated trade quantity', id=271, version=0, deprecated=0, encodedLength=4, offset=8, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
            //Token{signal=ENCODING, name='Int32', referencedName='null', description='int32', id=-1, version=0, deprecated=0, encodedLength=4, offset=8, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
            builder.append("mDEntrySize=");
            builder.append(mDEntrySize());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='SecurityID', referencedName='null', description='Security ID as defined by CME', id=48, version=0, deprecated=0, encodedLength=4, offset=12, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            builder.append(securityID());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='RptSeq', referencedName='null', description='Sequence number per instrument update', id=83, version=0, deprecated=0, encodedLength=4, offset=16, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            builder.append(numberOfOrders());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='AggressorSide', referencedName='null', description='Indicates which side is the aggressor or if there is no aggressor', id=5797, version=0, deprecated=0, encodedLength=1, offset=24, componentTokenCount=7, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=BEGIN_ENUM, name='AggressorSide', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=1, offset=24, componentTokenCount=5, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            builder.append("aggressorSide=");
            builder.append(aggressorSide());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='MDUpdateAction', referencedName='null', description='Market Data update action', id=279, version=0, deprecated=0, encodedLength=1, offset=25, componentTokenCount=10, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=BEGIN_ENUM, name='MDUpdateAction', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=1, offset=25, componentTokenCount=8, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            //Token{signal=ENCODING, name='MDEntryTypeTrade', referencedName='null', description='MDEntryTypeTrade', id=-1, version=0, deprecated=0, encodedLength=0, offset=26, componentTokenCount=1, encoding=Encoding{presence=CONSTANT, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=50, characterEncoding='US-ASCII', epoch='null', timeUnit=null, semanticType='char'}}
            //Token{signal=BEGIN_FIELD, name='MDTradeEntryID', referencedName='null', description='Market Data Trade entry ID', id=37711, version=7, deprecated=0, encodedLength=4, offset=26, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=ENCODING, name='uInt32NULL', referencedName='null', description='uInt32 optional', id=-1, version=0, deprecated=0, encodedLength=4, offset=26, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=4294967295, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        ...
        implements Iterable<NoOrderIDEntriesDecoder>, java.util.Iterator<NoOrderIDEntriesDecoder>
    {
        ...
        NoOrderIDEntriesDecoder(final MDIncrementalRefreshTradeSummary42Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        public void wrap(final DirectBuffer buffer)
        {
            ...
            parentMessage.limit(limit + HEADER_SIZE);
            blockLength = (int)(buffer.getShort(limit + 0, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF);
            count = (int)((short)(buffer.getByte(limit + 7) & 0xFF));
        }
        ...
        {
            builder.append('(');
            //Token{signal=BEGIN_FIELD, name='OrderID', referencedName='null', description='Unique order identifier as assigned by the exchange', id=37, version=0, deprecated=0, encodedLength=8, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            builder.append(orderID());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='LastQty', referencedName='null', description='Quantity bought or sold on this last fill', id=32, version=0, deprecated=0, encodedLength=4, offset=8, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
            //Token{signal=ENCODING, name='Int32', referencedName='null', description='int32', id=-1, version=0, deprecated=0, encodedLength=4, offset=8, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
