...
public class MDIncrementalRefreshDailyStatistics49Encoder
{
    ...
    {
        MDIncrementalRefreshDailyStatistics49Decoder writer = new MDIncrementalRefreshDailyStatistics49Decoder();
