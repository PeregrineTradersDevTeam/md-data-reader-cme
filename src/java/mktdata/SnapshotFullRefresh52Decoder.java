...
public class SnapshotFullRefresh52Decoder
{
    ...
    private final SnapshotFullRefresh52Decoder parentMessage = this;
    ...
    public SnapshotFullRefresh52Decoder wrap(
        ...
        implements Iterable<NoMDEntriesDecoder>, java.util.Iterator<NoMDEntriesDecoder>
    {
        ...
        private final SnapshotFullRefresh52Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoMDEntriesDecoder(final SnapshotFullRefresh52Decoder parentMessage)
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[SnapshotFullRefresh52](sbeTemplateId=");
        ...
        //Token{signal=ENCODING, name='uInt32', referencedName='null', description='uInt32', id=-1, version=0, deprecated=0, encodedLength=4, offset=12, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=35, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=43, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL9', referencedName='null', description='Optional Price with constant exponent -9', id=-1, version=9, deprecated=0, encodedLength=8, offset=51, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
