...
public class MDIncrementalRefreshBook46Decoder
{
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append(']');
        builder.append('|');
        //Token{signal=BEGIN_GROUP, name='NoOrderIDEntries', referencedName='null', description='Number of OrderID entries', id=37705, version=0, deprecated=0, encodedLength=24, offset=-1, componentTokenCount=25, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
