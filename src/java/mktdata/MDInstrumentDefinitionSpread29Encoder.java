...
public class MDInstrumentDefinitionSpread29Encoder
{
    ...
    public MDInstrumentDefinitionSpread29Encoder wrapAndApplyHeader(
    ...
    public MDInstrumentDefinitionSpread29Encoder securityExchange(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public MDInstrumentDefinitionSpread29Encoder securityExchange(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder securityGroup(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder securityGroup(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder asset(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder asset(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder symbol(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder symbol(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder securityType(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder securityType(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder cFICode(final int index, final byte value)
    {
        if (index < 0 || index >= 6)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder cFICode(final CharSequence src)
    {
        final int length = 6;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder currency(final int index, final byte value)
    {
        if (index < 0 || index >= 3)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder currency(final CharSequence src)
    {
        final int length = 3;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public MDInstrumentDefinitionSpread29Encoder securitySubType(final int index, final byte value)
    {
        if (index < 0 || index >= 5)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder securitySubType(final CharSequence src)
    {
        final int length = 5;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
     ...
     *
     * @return PRICENULLEncoder : Used for price calculation in spread and leg pricing
     */
    ...
    public MDInstrumentDefinitionSpread29Encoder unitOfMeasure(final int index, final byte value)
    {
        if (index < 0 || index >= 30)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public MDInstrumentDefinitionSpread29Encoder unitOfMeasure(final CharSequence src)
    {
        final int length = 30;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public static class NoEventsEncoder
    {
        ...
        private final MDInstrumentDefinitionSpread29Encoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;

        NoEventsEncoder(final MDInstrumentDefinitionSpread29Encoder parentMessage)
        {
    ...
    public static class NoMDFeedTypesEncoder
    {
        ...
        NoMDFeedTypesEncoder(final MDInstrumentDefinitionSpread29Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public static class NoInstAttribEncoder
    {
        ...
        NoInstAttribEncoder(final MDInstrumentDefinitionSpread29Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public static class NoLotTypeRulesEncoder
    {
        ...
        NoLotTypeRulesEncoder(final MDInstrumentDefinitionSpread29Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public static class NoLegsEncoder
    {
        ...
        NoLegsEncoder(final MDInstrumentDefinitionSpread29Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
         ...
         *
         * @return PRICENULLEncoder : Price for the future leg of a UDS Covered instrument 
         */
