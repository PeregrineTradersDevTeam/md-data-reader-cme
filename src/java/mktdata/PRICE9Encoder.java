...
public class PRICE9Encoder
{
    ...
    public PRICE9Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public PRICE9Encoder mantissa(final long value)
    {
    ...
    {
        PRICE9Decoder writer = new PRICE9Decoder();
