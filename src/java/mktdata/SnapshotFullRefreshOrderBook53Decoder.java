...
public class SnapshotFullRefreshOrderBook53Decoder
{
    ...
    private final SnapshotFullRefreshOrderBook53Decoder parentMessage = this;
    ...
    public SnapshotFullRefreshOrderBook53Decoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[SnapshotFullRefreshOrderBook53](sbeTemplateId=");
