...
public class Decimal9Decoder
{
    ...
    public Decimal9Decoder wrap(final DirectBuffer buffer, final int offset)
    {
    ...
    {
        builder.append('(');
        //Token{signal=ENCODING, name='mantissa', referencedName='null', description='mantissa', id=-1, version=0, deprecated=0, encodedLength=8, offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        builder.append("mantissa=");
        builder.append(mantissa());
        builder.append('|');
        //Token{signal=ENCODING, name='exponent', referencedName='null', description='exponent', id=-1, version=0, deprecated=0, encodedLength=0, offset=8, componentTokenCount=1, encoding=Encoding{presence=CONSTANT, primitiveType=INT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=-9, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        builder.append(')');
