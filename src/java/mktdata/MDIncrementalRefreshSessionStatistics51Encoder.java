...
public class MDIncrementalRefreshSessionStatistics51Encoder
{
    ...
    private final MDIncrementalRefreshSessionStatistics51Encoder parentMessage = this;
    ...
    public MDIncrementalRefreshSessionStatistics51Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public MDIncrementalRefreshSessionStatistics51Encoder wrapAndApplyHeader(
    ...
    public MDIncrementalRefreshSessionStatistics51Encoder transactTime(final long value)
    {
    ...
    public static class NoMDEntriesEncoder
    {
        ...
        private final MDIncrementalRefreshSessionStatistics51Encoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;

        NoMDEntriesEncoder(final MDIncrementalRefreshSessionStatistics51Encoder parentMessage)
        {
         ...
         *
         * @return PRICE9Encoder : Market Data entry price
         */
    ...
    {
        MDIncrementalRefreshSessionStatistics51Decoder writer = new MDIncrementalRefreshSessionStatistics51Decoder();
