...
public class PRICENULL9Encoder
{
    ...
    public PRICENULL9Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public PRICENULL9Encoder mantissa(final long value)
    {
    ...
    {
        PRICENULL9Decoder writer = new PRICENULL9Decoder();
