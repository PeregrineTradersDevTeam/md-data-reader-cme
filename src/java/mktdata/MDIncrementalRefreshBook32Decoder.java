...
public class MDIncrementalRefreshBook32Decoder
{
        ...
        implements Iterable<NoMDEntriesDecoder>, java.util.Iterator<NoMDEntriesDecoder>
    {
        ...
        private final MDIncrementalRefreshBook32Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoMDEntriesDecoder(final MDIncrementalRefreshBook32Decoder parentMessage)
        {
        ...
        public StringBuilder appendTo(final StringBuilder builder)
        {
            ...
            builder.append(rptSeq());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='NumberOfOrders', referencedName='null', description='In Book entry - aggregate number of orders at given price level', id=346, version=0, deprecated=0, encodedLength=4, offset=20, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            builder.append(numberOfOrders());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='MDPriceLevel', referencedName='null', description='Aggregate book level', id=1023, version=0, deprecated=0, encodedLength=1, offset=24, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=ENCODING, name='uInt8', referencedName='null', description='uInt8', id=-1, version=0, deprecated=0, encodedLength=1, offset=24, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            ...
            builder.append(mDUpdateAction());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='MDEntryType', referencedName='null', description='Market Data entry type', id=269, version=0, deprecated=0, encodedLength=1, offset=26, componentTokenCount=9, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='char'}}
            //Token{signal=BEGIN_ENUM, name='MDEntryTypeBook', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=1, offset=26, componentTokenCount=7, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='char'}}
        ...
        implements Iterable<NoOrderIDEntriesDecoder>, java.util.Iterator<NoOrderIDEntriesDecoder>
    {
        ...
        NoOrderIDEntriesDecoder(final MDIncrementalRefreshBook32Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
        ...
        public StringBuilder appendTo(final StringBuilder builder)
        {
            ...
            //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=4, offset=16, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            builder.append("mDDisplayQty=");
            builder.append(mDDisplayQty());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='ReferenceID', referencedName='null', description='Reference to corresponding Price and Security ID, sequence of MD entry in the message', id=9633, version=0, deprecated=0, encodedLength=1, offset=20, componentTokenCount=3, encoding=Encoding{presence=OPTIONAL, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='uInt8NULL', id=-1, version=0, deprecated=0, encodedLength=1, offset=20, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            builder.append("referenceID=");
            builder.append(referenceID());
            builder.append('|');
            //Token{signal=BEGIN_FIELD, name='OrderUpdateAction', referencedName='null', description='Order book update action to be applied to the order referenced by OrderID', id=37708, version=0, deprecated=0, encodedLength=1, offset=21, componentTokenCount=7, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
            //Token{signal=BEGIN_ENUM, name='OrderUpdateAction', referencedName='null', description='null', id=-1, version=7, deprecated=0, encodedLength=1, offset=21, componentTokenCount=5, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
